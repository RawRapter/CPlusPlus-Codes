/*
K-th level
Given a binary tree with n nodes. Task is to print its kth level.
Input: In the function a pointer to a root node is passed with height level
Output: Return a vector containing nodes at Kth level.
*/
